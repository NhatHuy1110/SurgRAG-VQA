"""
Centralized configuration for the Surgical RAG-VQA pipeline.
"""
...
QUESTIONS_FILE = ANNOTATIONS_DIR / "questions.json"
RETRIEVAL_EVAL_FILE = ANNOTATIONS_DIR / "retrieval_eval.json"
CHUNKS_FILE = DOCS_CHUNKS_DIR / "chunks.jsonl"
RESULTS_FILE = RESULTS_DIR / "spike_results.json"
...
DENSE_MODEL_NAME = os.environ.get("DENSE_MODEL_NAME", "sentence-transformers/all-MiniLM-L6-v2")
...
VLM_PROVIDER = os.environ.get("VLM_PROVIDER", "openai" if OPENAI_API_KEY else "mock_vlm")
OPENAI_VLM_MODEL = os.environ.get("OPENAI_VLM_MODEL", "gpt-4o")
LOCAL_VLM_MODEL = os.environ.get("LOCAL_VLM_MODEL", "llava-hf/llava-1.5-7b-hf")
...
for directory in [FRAMES_DIR, ANNOTATIONS_DIR, DOCS_RAW_DIR, DOCS_CHUNKS_DIR, RESULTS_DIR]:
