"""
build_corpus.py - Build the retrieval corpus for SurgRAG-VQA.

This script parses the curated source documents in `docs/raw/`, cleans and
segments the text, constructs parent/child chunks, enriches them with tags and
contextualized text, validates the output, and writes the final corpus to
...
# ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Output path: v3 separate from v2 (Fix #3) ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
...
_FRONT_MATTER_PATTERNS = [
    ...
    re.compile(r"^\s*\[\d+(?:\s*[-ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“,]\s*\d+)*\]\s*\.?\s*$", re.MULTILINE),
...
_REFERENCE_ENTRY_PATTERNS = [
    ...
    re.compile(r"^\s*\d{1,3}\.\s+[A-Z][A-Za-z'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢\-]+(?:\s+[A-Z][A-Za-z'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢\-]+)*(?:,\s*[A-Z]\.){1,3}.*$", re.IGNORECASE),
]
...
def _looks_like_reference_entry(line: str) -> bool:
    ...
    word_count = len(re.findall(r"[A-Za-z][A-Za-z'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢\-]*", body))
    cues = [
        "et al.",
        "journal",
        "commission",
    ...
    if word_count >= 6 and stripped.count(".") >= 2:
        ...
        clause_words = re.findall(r"[A-Za-z][A-Za-z'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢\-]*", first_clause)
        titlecase_words = sum(1 for w in clause_words if re.match(r"^[A-Z][A-Za-z'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢\-]+$", w))
        if remainder and (
            "," in first_clause
...
def _is_front_matter_page(lines: list[str]) -> bool:
    ...
    short_title_lines = sum(
        ...
        if 1 <= len(re.findall(r"[A-Za-z][A-Za-z'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢\-]*", line)) <= 8
    )
...
_heading_re_final = [re.compile(p, re.MULTILINE) for p in HEADING_PATTERNS_FINAL]
...
def _is_heading(line: str) -> bool:
    ...
    if re.match(r"^\d+(?:\.\d+){0,2}\.?\s+(?:In|On|At|The|A|An|This|These)\b", stripped):
        return False
    if not any(p.match(stripped) for p in _heading_re_final):
        return False
...
def sentence_split(text: str) -> list[str]:
    ...
    for para in re.split(r"\n\s*\n", text):
        ...
        for abbr in _ABBREVS:
            protected = protected.replace(abbr, abbr.replace(".", "Ãƒâ€šÃ‚Â§"))
        for part in re.split(r'(?<=[.!?])\s+', protected):
            restored = part.replace("Ãƒâ€šÃ‚Â§", ".").strip()
            if restored:
...
# ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Anatomy ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
ANATOMY_KEYWORDS = {
...
# ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Instruments ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ (port, clip, hook, camera REMOVED as standalone)
INSTRUMENT_KEYWORDS = {
...
# ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Actions ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ (clip, cut, wash REMOVED as standalone)
ACTION_KEYWORDS = {
...
# ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Risks ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
RISK_KEYWORDS = {
...
# ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Phases ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
PHASE_KEYWORDS = {
...
def main():
    ...
    # ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Validation ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
    print(f"\n{'-'*60}")
    print("VALIDATION:")
    ...
    # ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Write ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
    DOCS_CHUNKS_DIR.mkdir(parents=True, exist_ok=True)
    with open(CHUNKS_FILE, "w", encoding="utf-8") as f:
        for chunk in all_chunks:
            f.write(json.dumps(chunk, ensure_ascii=False) + "\n")

    # ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Report ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
    print(f"\n{'='*60}")
